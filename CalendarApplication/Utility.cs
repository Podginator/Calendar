...
namespace Calendar
{
    class Utility
    {
        ...
        //Round a DateTime to the nearest Thirty Minute Interval.
        public static DateTime RoundToThirty(DateTime date)
        {
            return new DateTime(((date.Ticks + TimeSpan.FromMinutes(30).Ticks - 1) / TimeSpan.FromMinutes(30).Ticks) * TimeSpan.FromMinutes(30).Ticks);
        }
    }
}
